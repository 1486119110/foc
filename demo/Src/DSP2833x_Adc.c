...
//0.010986328125=0.732421875*0.01*1.5  1mv 0.01 ------------ ADC ֵתΪλĻϵ
     ic=_IQdiv(_IQmpy((_IQ(ADC_U)-_IQ(HALL_U)),_IQ(0.010986328125)),_IQ(E_Ding_DianLiu));//MVתΪIQʽ˷
...
void DC_Link(void) // ĸߵѹ
{
    U_dc = 0.2951 * (AD_BUF[7] + AD_BUF[6]);
    U_dc = U_dc * 0.732421875 / 2.0; // 12λADCѹ1LSB=3/pow(2,12)
 ...
 if((I_A>GuoliuZhi)||(I_B>GuoliuZhi)||(I_C>GuoliuZhi))
  ...
  if((IA>80.0)||(IB>80.0)||(IC>80.0))
    ...
    temp=_IQabs(_IQdiv(temp, _IQ(10000)));//ƽֵ
