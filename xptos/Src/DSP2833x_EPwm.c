...
#define deadtime 200
_iq LineEncoder=32768000;//即为1000线编码器
...
void  QEP_Init(void)
{
    ...
    TotalPulse=_IQmpy(_IQ(4),LineEncoder);//经过解码模块，工作在正交模式下，产生4000个脉冲
    EQep1Regs.QPOSMAX= (Uint16)(TotalPulse>>15);//右移15位，相当于除以2^15，也就是把Q15转换为标准整数int形式，4000
